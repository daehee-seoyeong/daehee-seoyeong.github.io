...
function launchDaumMap() {
    if (window.confirm("카카오맵 웹페이지로 이동하시겠습니까?"))
    { window.open("https://m.map.kakao.com/actions/searchView?q=%EB%B9%84%EB%A0%8C%ED%8B%B0#!/245466707/map/place"); }

    // var clickedAt = +new Date;

    // var kakaoMapAppCheckTimer = setTimeout(function() {
    //     if (+new Date - clickedAt < 2000){
    //         if (window.confirm("카카오맵 웹페이지로 이동하시겠습니까?"))
    //         { windows.open("https://m.map.kakao.com/actions/searchView?q=%EB%B9%84%EB%A0%8C%ED%8B%B0#!/245466707/map/place"); }
    //     }
    // }, 1500);
